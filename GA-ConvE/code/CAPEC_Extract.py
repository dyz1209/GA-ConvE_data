...
def main():
    ...
    # Read the CSV file
    with open('../data/capec_data.csv', 'r', encoding='latin-1') as file:
        ...
        for row in reader:
            ...
            # Count the word frequencies, excluding specified words
            for word in words:
    ...
    with open('../data/CAPEC_Matrix.csv', 'w', newline='', encoding='utf-8') as file:
        writer = csv.writer(file)
        writer.writerows(output_data)

# This ensures the main() function is executed when the script is run
